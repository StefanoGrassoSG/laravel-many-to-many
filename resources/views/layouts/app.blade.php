                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a href="{{ route('admin.projects.index') }}"
                                    @class([
                                        $linkClasses,
                                        'bg-white text-primary' => request()->routeIs('admin.projects.index'),
                                        'text-white' => !request()->routeIs('admin.projects.index')
                                    ])>
                                    All Projects
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.types.index') }}"
                                    @class([
                                        $linkClasses,
                                        'bg-white text-primary' => request()->routeIs('admin.types.index'),
                                        'text-white' => !request()->routeIs('admin.types.index')
                                    ])>
                                    Types
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.technologies.index') }}"
                                    @class([
                                        $linkClasses,
                                        'bg-white text-primary' => request()->routeIs('admin.technologies.index'),
                                        'text-white' => !request()->routeIs('admin.technologies.index')
                                    ])>
                                    Technologies
                                </a>
                            </li>
